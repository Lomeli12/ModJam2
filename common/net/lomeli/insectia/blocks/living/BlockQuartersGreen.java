...
public class BlockQuartersGreen extends BlockContainer{

	private Icon[] iconArray;
	public BlockQuartersGreen(int par1) {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, 
		...
		if(world != null && !world.isRemote){
			if(entityPlayer != null){
				TileEntityGreen tileEntity = (TileEntityGreen)world.getBlockTileEntity(x, y, z);
				if(tileEntity != null){
	...
	public void registerIcons(IconRegister iconRegister){
		...
		this.iconArray[0] = iconRegister.registerIcon(ModStrings.MOD_ID.toLowerCase() + ":livingQuarters_2");
